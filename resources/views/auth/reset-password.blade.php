    ...
    <main class="auth-shell">
        <div class="auth-grid">
            <aside class="auth-side">
                <span class="badge-trust"><i class="fas fa-shield-alt"></i> Secure Reset</span>
                <h1 class="auth-title">Atur Password Baru Admin</h1>
                <p class="auth-subtitle">Gunakan kombinasi password yang kuat, lalu simpan dengan aman untuk akses dashboard pengurus.</p>
            </aside>
            ...
            <section class="auth-form-wrap d-flex flex-column justify-content-center">
                <div class="text-center mb-4">
                    ...
                    <p class="text-muted mb-0">Masukkan data akun dan password baru</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control border-end-0" id="password" name="password" autocomplete="new-password" required>
                            <button class="btn btn-pass-toggle" type="button" id="togglePassword" aria-label="Tampilkan password baru">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i class="fas fa-lock"></i></span>
                            <input type="password" class="form-control border-end-0" id="password_confirmation" name="password_confirmation" autocomplete="new-password" required>
                            <button class="btn btn-pass-toggle" type="button" id="togglePasswordConfirm" aria-label="Tampilkan konfirmasi password">
                                <i class="fas fa-eye"></i>
                            </button>
                        </div>
                    </div>

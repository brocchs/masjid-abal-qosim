            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <div>
                            <span class="inline-block px-3 py-1 text-sm font-semibold rounded {{ $transaction->type == 'credit' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div>
                            @if($transaction->invoice_file)
                                <a href="{{ Storage::url($transaction->invoice_file) }}" target="_blank" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded inline-block">
                ...
                <div class="flex justify-between mt-6">
                    ...
                    <div class="space-x-2">
                        <a href="{{ route('transactions.edit', $transaction) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded">
                            <i class="fas fa-edit mr-2"></i>
                            Edit
                        </a>
